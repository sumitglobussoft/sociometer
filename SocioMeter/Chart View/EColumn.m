...
-(void)setGrade:(float)grade
{
   ...
   // NSLog(@"grade ==>>>%f",grade);
	...
	[progressline addLineToPoint:CGPointMake(self.frame.size.width/2.0, self.frame.size.height- grade )];
  //  NSLog(@"frame width %f %f",self.frame.size.width/2,self.frame.size.height);
...
- (UIColor *)barColor
{
    return [UIColor colorWithRed:(CGFloat)206/255 green:(CGFloat)206/255 blue:(CGFloat)206/255 alpha:1];
}
