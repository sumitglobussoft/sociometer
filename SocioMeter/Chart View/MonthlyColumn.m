...
-(void)setGrade:(float)grade
{
    ...
    [progressline addLineToPoint:CGPointMake(self.frame.size.width/2.0, (1 - grade) * self.frame.size.height/2)];
    
    [progressline setLineWidth:5.5];
