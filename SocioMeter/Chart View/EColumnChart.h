...
@property(assign,nonatomic)NSInteger totalColumnsRequired;
@property(assign,nonatomic) float totalScore;
@property(strong,nonatomic) NSString * typeOfGraph;
@property(assign,nonatomic)NSInteger totalColumns;
@end
